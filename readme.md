...
> A lot of this stuff will be review, but their might be a couple of subtleties and nuances we'll pick up. That said, if you'd rather, run through [these exercises](https://github.com/ga-wdi-exercises/js-data-types/blob/master/exercise.md) on your own
